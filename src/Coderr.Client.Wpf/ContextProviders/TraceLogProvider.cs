...
namespace Coderr.Client.Wpf.ContextProviders
{
    ...
    /// </summary>
    public class TraceLogsProvider : IContextCollectionProvider
    {
        /// <summary>
        /// Instance used to add log4net lines.
        /// </summary>
        public static readonly TraceLogsProvider Instance = new TraceLogsProvider();
        ...
        /// <inheritdoc />
        public string Name { get; } = "TraceLogsProvider";
